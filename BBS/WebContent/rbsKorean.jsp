...
<body>
	<%
		...
		ArrayList<Rbs> list = rbsDAO.getCategoryList("한식");
	...
	<ul class="menu">
		...
		<li><a class="active" href="rbsKorean.jsp">Korean</a></li>
		...
		<li><a class="before" href="rbsKorean.jsp">Desert</a></li>
	</ul>
	</nav>
		...
		<div class="row">
			...
			<div align="center">
				<%
					if (pageNumber != 1) {
				%>
				<a href="rbsKorean.jsp?pageNumber=<%=pageNumber - 1%>"
				...
				<%
					...
					for (int i = startPage; i <= endPage; i++) {
						if (i == pageNumber) {
				%>
				<a href="rbsKorean.jsp?pageNumber=<%=i%>"><b>&nbsp;&nbsp;<%=i%>&nbsp;&nbsp;
				</b></a>
				<%
					} else {
				%>
				<a href="rbsKorean.jsp?pageNumber=<%=i%>">&nbsp;&nbsp;<%=i%>&nbsp;&nbsp;
				</a>
				<%
					}
					}
